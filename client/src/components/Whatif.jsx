...
export default function Whatif() {
    ...
    const handleInvestment = () => {
        ...
        for (let i = 0; i < duration; i++) {
            currentSavings =
                currentSavings * (1 + returnProfit) + yearlyContribution;
            TotalContribution = TotalContribution + yearlyContribution;

            let TotalInvestment =
                parseFloat(currentSavings) - parseFloat(TotalContribution);
    ...
    return (
        <div class="container ">
            <div class="column box is-one-third">
                ...
                <button class="button is-primary" onClick={handleInvestment}>
                    Primary
                </button>
            </div>
        </div>
